                            ...
                            int weightRank)
{
    switch (opType)
    {
        ...
        case Op_ARGMAX:
            ...
            break;
        case Op_AVG_POOL2D:
            DEF_FACTORY_ONE_TYPE_ONE_ACCUM(OpAvgPool2d, AvgPool2d, FP16, FP16);
            DEF_FACTORY_ONE_TYPE_ONE_ACCUM(OpAvgPool2d, AvgPool2d, FP16, FP32);
            DEF_FACTORY_ONE_TYPE_ONE_ACCUM(OpAvgPool2d, AvgPool2d, BF16, FP32);
            DEF_FACTORY_ONE_TYPE_ONE_ACCUM(OpAvgPool2d, AvgPool2d, FP32, FP32);
            DEF_FACTORY_ONE_TYPE_ONE_ACCUM(OpAvgPool2d, AvgPool2d, INT8, INT32);
            DEF_FACTORY_ONE_TYPE_ONE_ACCUM(OpAvgPool2d, AvgPool2d, INT16, INT32);
            DEF_FACTORY_ONE_TYPE_ONE_ACCUM(OpAvgPool2d, AvgPool2d, FP64, FP64);
            DEF_FACTORY_ONE_TYPE_ONE_ACCUM(OpAvgPool2d, AvgPool2d, FP8E4M3, FP16);
            DEF_FACTORY_ONE_TYPE_ONE_ACCUM(OpAvgPool2d, AvgPool2d, FP8E5M2, FP16);
            break;
        case Op_CONV2D:
            // OP, attr_name, in_t, w_t, acc_t, out_t
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv2d, Conv2d, FP16, FP16, FP16, FP16);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv2d, Conv2d, FP16, FP16, FP32, FP16);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv2d, Conv2d, BF16, BF16, FP32, BF16);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv2d, Conv2d, FP32, FP32, FP32, FP32);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv2d, Conv2d, INT8, INT4, INT32, INT32);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv2d, Conv2d, INT8, INT8, INT32, INT32);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv2d, Conv2d, INT16, INT8, INT48, INT48);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv2d, Conv2d, FP64, FP64, FP64, FP64);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv2d, Conv2d, FP8E4M3, FP8E4M3, FP16, FP16);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv2d, Conv2d, FP8E5M2, FP8E5M2, FP16, FP16);
            break;
        case Op_CONV3D:
            // OP, attr_name, in_t, w_t, acc_t, out_t
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv3d, Conv3d, FP16, FP16, FP16, FP16);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv3d, Conv3d, FP16, FP16, FP32, FP16);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv3d, Conv3d, BF16, BF16, FP32, BF16);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv3d, Conv3d, FP32, FP32, FP32, FP32);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv3d, Conv3d, INT8, INT4, INT32, INT32);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv3d, Conv3d, INT8, INT8, INT32, INT32);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv3d, Conv3d, INT16, INT8, INT48, INT48);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv3d, Conv3d, FP64, FP64, FP64, FP64);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv3d, Conv3d, FP8E4M3, FP8E4M3, FP16, FP16);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpConv3d, Conv3d, FP8E5M2, FP8E5M2, FP16, FP16);
            break;
        case Op_DEPTHWISE_CONV2D:
            // OP, attr_name, in_t, w_t, acc_t, out_t
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpDepthwiseConv2d, DepthwiseConv2d, FP16, FP16, FP16, FP16);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpDepthwiseConv2d, DepthwiseConv2d, FP16, FP16, FP32, FP16);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpDepthwiseConv2d, DepthwiseConv2d, BF16, BF16, FP32, BF16);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpDepthwiseConv2d, DepthwiseConv2d, FP32, FP32, FP32, FP32);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpDepthwiseConv2d, DepthwiseConv2d, INT8, INT4, INT32, INT32);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpDepthwiseConv2d, DepthwiseConv2d, INT8, INT8, INT32, INT32);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpDepthwiseConv2d, DepthwiseConv2d, INT16, INT8, INT48, INT48);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpDepthwiseConv2d, DepthwiseConv2d, FP64, FP64, FP64, FP64);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpDepthwiseConv2d, DepthwiseConv2d, FP8E4M3, FP8E4M3, FP16, FP16);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpDepthwiseConv2d, DepthwiseConv2d, FP8E5M2, FP8E5M2, FP16, FP16);
            break;
        case Op_FFT2D:
            ...
            break;
        case Op_MATMUL:
            DEF_FACTORY_THREE_TYPE(OpMatMul, FP16, FP16, FP16);
            DEF_FACTORY_THREE_TYPE(OpMatMul, FP16, FP16, FP32);
            DEF_FACTORY_THREE_TYPE(OpMatMul, BF16, BF16, FP32);
            DEF_FACTORY_THREE_TYPE(OpMatMul, FP32, FP32, FP32);
            DEF_FACTORY_THREE_TYPE(OpMatMul, INT8, INT8, INT32);
            DEF_FACTORY_THREE_TYPE(OpMatMul, INT16, INT16, INT48);
            DEF_FACTORY_THREE_TYPE(OpMatMul, FP64, FP64, FP64);
            DEF_FACTORY_THREE_TYPE(OpMatMul, FP8E4M3, FP8E4M3, FP16);
            DEF_FACTORY_THREE_TYPE(OpMatMul, FP8E5M2, FP8E5M2, FP16);
            DEF_FACTORY_THREE_TYPE(OpMatMul, FP8E4M3, FP8E4M3, FP32);
            DEF_FACTORY_THREE_TYPE(OpMatMul, FP8E5M2, FP8E5M2, FP32);
            DEF_FACTORY_THREE_TYPE(OpMatMul, FP8E4M3, FP8E5M2, FP16);
            DEF_FACTORY_THREE_TYPE(OpMatMul, FP8E5M2, FP8E4M3, FP16);
            DEF_FACTORY_THREE_TYPE(OpMatMul, FP8E4M3, FP8E5M2, FP32);
            DEF_FACTORY_THREE_TYPE(OpMatMul, FP8E5M2, FP8E4M3, FP32);
            break;
        case Op_MAX_POOL2D:
        ...
        case Op_TRANSPOSE_CONV2D:
            // OP, attr_name, in_t, w_t, acc_t, out_t
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpTransposeConv2d, TransposeConv2d, FP16, FP16, FP16, FP16);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpTransposeConv2d, TransposeConv2d, FP16, FP16, FP32, FP16);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpTransposeConv2d, TransposeConv2d, BF16, BF16, FP32, BF16);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpTransposeConv2d, TransposeConv2d, FP32, FP32, FP32, FP32);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpTransposeConv2d, TransposeConv2d, INT8, INT4, INT32, INT32);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpTransposeConv2d, TransposeConv2d, INT8, INT8, INT32, INT32);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpTransposeConv2d, TransposeConv2d, INT16, INT8, INT48, INT48);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpTransposeConv2d, TransposeConv2d, FP64, FP64, FP64, FP64);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpTransposeConv2d, TransposeConv2d, FP8E4M3, FP8E4M3, FP16, FP16);
            DEF_FACTORY_THREE_TYPE_ONE_ACCUM(OpTransposeConv2d, TransposeConv2d, FP8E5M2, FP8E5M2, FP16, FP16);
            break;
